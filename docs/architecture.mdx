...
**Sponsored transactions** — NestJS sponsors the transactions that require it: passport minting and INK minting/transfers. USDC transfers are free on Sui and need no sponsorship.
